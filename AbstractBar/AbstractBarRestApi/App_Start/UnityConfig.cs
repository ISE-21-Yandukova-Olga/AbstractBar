...
namespace AbstractBarRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IBarmenService, BarmenServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<ICoctailService, CoctailServiceBD>(new HierarchicalLifetimeManager());
