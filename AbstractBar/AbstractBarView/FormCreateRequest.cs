    ...
    public partial class FormCreateRequest : Form
    {
        ...
        private void FormCreateRequest_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                List<CoctailViewModel> listP = Task.Run(() => APIClient.GetRequestData<List<CoctailViewModel>>("api/Coctail/GetList")).Result;
                if (listP != null)
                {
        ...
        private void CalcSum()
        {
            if (comboBoxProduct.SelectedValue != null && !string.IsNullOrEmpty(textBoxCount.Text))
            {
                try
                {
                    ...
                    CoctailViewModel product = Task.Run(() => APIClient.GetRequestData<CoctailViewModel>("api/Coctail/Get/" + id)).Result;
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            Task task = Task.Run(() => APIClient.PostRequestData("api/Main/CreateRequest", new RequestBindingModel
            {
                CustomerId = clientId,
                CoctailId = productId,
                Count = count,
